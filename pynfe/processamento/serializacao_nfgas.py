...
from pynfe_nasajon.pynfe.utils.nfgas.ev_canc_nfgas_v1_00 import (
    EvCancNfgas,
    EvCancNfgasDescEvento,
)
    ...
    def montar_evento_cancelamento(
        ...
        *,
        ...
        det_evento = Tevento.InfEvento.DetEvento(
            any_element=EvCancNfgas(
                desc_evento=EvCancNfgasDescEvento.CANCELAMENTO,
                n_prot=protocolo,
