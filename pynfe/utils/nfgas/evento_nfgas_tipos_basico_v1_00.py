...
class Tevento:
    ...
    class InfEvento:
        ...
        :ivar ch_nfgas: Chave de Acesso da NFGas vinculada ao evento
        ...
        :ivar id: Identificador da TAG a ser assinada, a regra de
            formação do Id é: “ID” + tpEvento +  chave da NFGas +
            nSeqEvento
        """
...
class TretEvento:
    ...
    class InfEvento:
        ...
        :ivar x_motivo: Descrição literal do status do registro do
            Evento
        :ivar ch_nfgas: Chave de Acesso NFGas vinculada
...
class TprocEvento:
    ...
    ret_evento_nfgas: TretEvento = field(
        metadata={
            "name": "retEventoNFGas",
            "type": "Element",
            "namespace": "http://www.portalfiscal.inf.br/nfgas",
