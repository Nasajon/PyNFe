# /app/output/DPS_v1_00.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:c27cf6a1980499753073c1afd72a5bfd80976ec9
# Generated 2025-09-22 19:54:26.964004 by PyXB version 1.2.6 using Python 3.12.11.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:7af0813a-7031-4142-9610-6d30236ff053')
...
DPS = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DPS'), TCDPS, documentation='Schema XML da Declaração de Prestação de Serviços - DPS', location=pyxb.utils.utility.Location('file:///app/pynfe_nasajon/pynfe/data/XSDs/NFS-e/nacional/DPS_v1.00.xsd', 9, 2))
