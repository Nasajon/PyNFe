# /app/output/evento_v1_00.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:c27cf6a1980499753073c1afd72a5bfd80976ec9
# Generated 2025-09-29 12:21:47.888972 by PyXB version 1.2.6 using Python 3.12.11.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:c7a6c427-2510-4236-a553-b4b2566c2e83')
...
evento = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'evento'), TCEvento, documentation='Schema XML do Pedido de Registro de Eventos', location=pyxb.utils.utility.Location('file:///app/pynfe_nasajon/pynfe/data/XSDs/NFS-e/nacional/evento_v1.00.xsd', 10, 2))
Namespace.addCategoryObject('elementBinding', evento.name().localName(), evento)
